                                ...
                                <div id="<?php echo 'accordion' . $i ?>" class="accordion my-3">
                                    <div class="card">
                                        ...
                                        <div style="background: #7c83fd; cursor:pointer;border-radius: 9px;" class="card-header border-0" data-toggle="collapse" href="<?php echo '#collapseOne' . $i  ?>" aria-controls="collapse1">
                                            <span>
                                                <i class="fas fa-sort-down mr-3 cart-text"></i>
                                                <?php echo $modulosC['nombreModulo'] ?>
                                            </span>
                                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-5 col-lg-4 pt-5 responsbott">
                    <div class="card imagecuadr">
                        <div class="content-img">
                            ...
                            <?php if ($dato4['imagenDestacadaCurso'] != null) { ?>
                                                ...
                                                if ($dato4['costoCurso'] != 0) {
                                                    ...
                                                    <div class="my-1" style="font-size: 13px;">
                                                        ...
                                                        <div style="padding-left: 28px;">
                                                            ...
                                                            <span class="ml-3">es 14<?php //echo $minimo_respuestas_para_aprobar; 
                                                                                    ?></span>
                                                        </div>
            ...
            <div class="flex topup">
                <?php if (isset($_SESSION['Logueado']) && ($_SESSION['Logueado'] === true)) { ?>
                    ...
                    <div class="comments-container" style="border-radius: 40px;" id="foro-curso">
                        <h1 style="font-size: 34px; color: #7C83FD; font-weight: bold;">Foro Educalma</h1>
