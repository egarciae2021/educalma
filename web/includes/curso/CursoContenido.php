            ...
            <div class="row">
               <div class="container-detalle-course col-12 col sm-12 col-md-6 col-lg-6 col-xl-6 responsv5">
                  ...
                  <div class="rankin-course my-3">
                     <i class="fas fa-star m-1 color1"></i><i class="fas fa-star m-1 color1"></i><i class="fas fa-star m-1 color1"></i><i class="fas fa-star m-1 color1"></i><i class="fas fa-star m-1 color1"></i>
               ...
               <div class="container-image-course col-12 col sm-12 col-md-6 col-lg-6 col-xl-6 responsv5">
                  <div class="image-course">
                     ...
                     if ($dato4['imagenDestacadaCurso'] != null) {
                        ...
                        echo ' <img src="./assets/images/curso_educalma.png" alt="foto_curso" >';
                     }
                     ?>
                  </div>
               </div>
         ...
         <div class="container-detalle-informacion">
            ...
            <div class="flex topup mt-4">
               ...
               <?php if (isset($_SESSION['Logueado']) && ($_SESSION['Logueado'] === true)) { ?>
                  ...
                  <div class="comments-container" style="border-radius: 40px;" id="foro-curso">
                     <!-- TITULO FORO EDUCALMA -->
                     <h4 style="font-size: 26px; color: #7C83FD; font-weight: bold;">Comenta sobre el curso</h4>
                     ...
                     <h4 style="font-size: 26px; margin-top: 34px; color: #7C83FD; font-weight: bold;"">Destacados</h4>
                     <!-- BOTON COMENTAR -->
                     <!-- BOTON ELIMINAR TODO -->
                                 ...
                                 <div class="comment-main-level">
                                    ...
                                    <div class="comment-box">
                                       <div class="comment-head">
                                          ...
                                          <button type="button" id="modal" class="btn btn-sm" onclick="msje_Redireccion()">Responder</button>
                                          <a class="fb-xfbml-parse-ignore" target="_blank" href="http://www.facebook.com/sharer.php?s=100&p[url]=http://educalma.fundacioncalma.org/detallecurso.php?id=<?php echo $idCurso; ?>&p[title]=prueba&p[summary]=descripcion_contenido&display=page" onclick="window.open(this.href, this.target, 'width=300,height=400')"><i style="color:white;" class="fa fa-reply"></i></a>
                                          <a href="#">
                                             <i style="color:white;" class="fa fa-heart"></i>
                                          </a>
                                       </div>
                                    ...
                                    <ul class="comments-list reply-list">
                                       <li>
                                          ...
                                          <div class="comment-box">
                                             <div class="comment-head">
                                                <h6 class="commen-name<?php echo $autor; ?>">
                                                   <span><?php echo $registro2['user_men']; ?></span>
                                                </h6>
                                                <span>
                                                   <?php
                                                   $fecha1_2 = new DateTime($registro2['fecha_ingreso']);
                  ...
                  <div class="container-nina">
                     <img src="assets/images/ilu-nina.png" class="img-nina">
                  </div>
            </div>
            <!-- Foro -->
            <!-- fin foro -->
               ...
               function con_certificado() {
                  ...
                  function dataLoaded() {
                     if (this.status == 200) {
                        ...
                        setTimeout(function() {
                           console.log("Se esta descargando el certificado");
