            ...
            <div class="w-100  pl-5 pr-5">
                <nav class="navbar header-nav navbar-expand-lg">
                    <div class="container-fluid d-flex justify-content-between">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                            <ul class="navbar-nav">
                                ...
                                <button type="button" class="dropdown-toggle" id="curso-btn"
                    ...
                    if(isset($_SESSION['Logueado']) && $_SESSION['Logueado'] === true){
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbar-wd">
                            <ul class="navbar-nav">
                                <li class="nav-item my-auto ms-10 ms-lg-0"
                                    style="padding-left: 90px; vertical-align: center;">
                                    <div class="dropdown">

                                        <!--<a class="dropdown-toggle btn-dropdown" onclick="dropdown();" role="button" data-toggle="dropdown" style="background-color: #7C83FD; color: #fff; border-radius: 120px; padding: 15px; cursor: pointer;"></a>-->
                                        <a class="dropdown-toggle btn-dropdown" onclick="dropdown();" role="button"
                                            data-toggle="dropdown" style="cursor: pointer;"><img
                                                src="data:image/*;base64,<?php echo base64_encode($dato['mifoto']);?>"
                                                alt="foto_curso"
                                                style="width: 50px;height:45px;border-radius: 50%;"></a>
                                        <div class="dropdown-menu content_dropdown" id="menu_dropdown">
                                            <a class="dropdown-item"
                                                href="user-sidebar.php">Dashboard</a>
                ...
                ?>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                            <ul class="navbar-nav">
                                <li>
                                    <a href="registros.php"><button type="button"
                                            class="roundedpill w165 mdl2 btn btn-lg btn-block btn-outline-primary">Registrar</button></a>
                                </li>

                                <li>
                                    <a href="iniciosesion.php"><button type="button"
                                            class="roundedpill  w165 mdl2 btn btn-lg btn-block btn-primary ">Login</button></a>
                                </li>
                            </ul>
                        </div>
                        <?php 
