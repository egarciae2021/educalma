                    ...
                    <div class="container-info-resumen mt-3" style="background-color: white;">
                        <div class="px-4 py-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right"><span>$.<?php echo ($dato['costoCurso'] * $subs); ?>.00</span></div>
                            </div>
                            <div class="row mt-3">
                                ...
                                <div class="col-7 col-lg-6 col-xl-7 text-leftt"><span><?php echo $dato['nombreCurso']; ?></span>
                                    <p class="font-weight-bold text-danger">$.<?php echo ($dato['costoCurso'] * $subs); ?>.00</p>
                                </div>
                            </div>
                            <hr>
                            <div class="mt-2">
            ...
            paypal.Buttons({
                ...
                createOrder: function(data, actions) {
                    return actions.order.create({
                        purchase_units: [{
                            amount: {
                                value: <?php echo ($dato['costoCurso'] * $subs); ?>
                            }
