...
-- pass: July123456
INSERT INTO usuarios VALUES (1, 3, 0, 0, 'JULY', 'CASTILLO', 'BARRERA','j@gmail.com', '$2y$10$eC0Uu2bWV/Gqm1rjuB3oL.DnA8FaDkLpjF/.Wi8604GaLu1aN2/xG', '965478456', 1, '89475632', 2, '1992-07-28', 'PERÚ', 1, 1, now(), null);

-- pass: Julio123456
INSERT INTO usuarios VALUES (2, 1, 0, 0, 'JULIO', 'CESAR', 'TELLO','tello@gmail.com', '$2y$10$tyWFJ1bWHdciAaxbGAk7uu.HIPoZw3uDKJJ4Rv7914wh6Hai9iroi', '954555784', 1, '55784952', 1, '1989-04-02', 'PERÚ', 1, 1, now(), null);

-- pass: Marleni123456
INSERT INTO usuarios VALUES (3, 2, 0, 0, 'MARLENE', 'VASQUEZ', 'VERA','marlene@gmail.com', '$2y$10$apc7Qxi7dW5FRo0Ki9BOue2FRp/yfBWhiCeVnRAQGoNgxkMpvlMhy', '989874852', 1, '05554874', 2, '1980-03-18', 'PERÚ', 3, 1, now(), null);

-- pass: Gloria123456
INSERT INTO usuarios VALUES (4, 2, 1, 0, 'GLORIA', 'SAC', 'LECHE','gloria@gloria.com', '$2y$10$4X1m7wnrbbuuOvqYRkd7gu26Xik2WpYZVQ/OVFvRC05gEp13yFQSa', '999874520', 4, '10554878920', 5, '1900-03-18', 'PERÚ', 1, 1, now(), null);

-- pass: Estefany123456
INSERT INTO usuarios VALUES (5, 1, 0, 1, 'ESTEFANY', 'MATA', 'MATOS','estefany@gloria.com', '$2y$10$OGIZkqniYZsz1HQfcKdzfuNa0pyjYFGPB1K71uXrigk4ITw5xFJxW', '963259658', 1, '02698974', 2, '1990-01-05', 'PERÚ', 1, 1, now(), null);

-- pass: nose XD
INSERT INTO usuarios VALUES (6, 1, 0, 1, 'MATA', 'MATA', 'MATOS','educalma@calma.com', '$2y$10$ZCyPSbUMoUa9C2vA3CNfR.caGn8Q2cc3Z1OFgH4rssGJu3JatBVGG', '963259658', 1, '02698974', 2, '1990-01-05', 'PERÚ', 1, 1, now(), null);
